...
class App extends React.Component {
  ...
  requestPredict= () => {
    ...
    .then ( (response) => {
      if (response){
        ...
        this.handleExpressions(response.expressions)
        this.setState({
  ...
  handleExpressions = (expresiones) => {
    this.props.changeExpression(expresiones)
  }
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-12 col-md-8 col-lg-9" id="info">
              <InfoExpressions  expressions={this.state.expressions} changeExpression={this.props.changeExpression}></InfoExpressions>
            </div>
          </div>
        </div>
    );
